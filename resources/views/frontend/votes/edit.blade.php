                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.votes.update", [$vote->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="value" id="value" value="{{ old('value', $vote->value) }}" step="1" required>
                            @if($errors->has('value'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user" id="user" value="{{ old('user', $vote->user) }}" step="1" required>
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('user') }}
                                </div>
