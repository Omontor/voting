        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('data_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/candidates*") ? "menu-open" : "" }} {{ request()->is("admin/months*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/candidates*") ? "active" : "" }} {{ request()->is("admin/months*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-database">

                            </i>
                            <p>
                                {{ trans('cruds.dataManagement.title') }}
                ...
                @endcan
                @can('voting_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/votes*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/votes*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-boxes">

                            </i>
                            <p>
                                {{ trans('cruds.votingManagement.title') }}
                                <i class="right fa fa-fw fa-angle-left nav-icon"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
