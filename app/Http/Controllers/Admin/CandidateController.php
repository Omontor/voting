...
class CandidateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.candidates.index', compact('candidates', 'months', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.candidates.create', compact('creators', 'months'));
    }
    ...
    public function edit(Candidate $candidate)
    {
        ...
        return view('admin.candidates.edit', compact('candidate', 'creators', 'months'));
    }
